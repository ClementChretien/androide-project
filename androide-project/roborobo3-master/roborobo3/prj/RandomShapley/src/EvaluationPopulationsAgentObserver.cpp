...
EvaluationPopulationsAgentObserver::EvaluationPopulationsAgentObserver( )
{
}

EvaluationPopulationsAgentObserver::EvaluationPopulationsAgentObserver( RobotWorldModel *__wm )
{
	_wm = __wm;
}
...
void EvaluationPopulationsAgentObserver::reset()
{
	// nothing to do.
}

void EvaluationPopulationsAgentObserver::stepPre()
{
