...
EvaluationPopulationsController::~EvaluationPopulationsController()
{
	// nothing to do.
}

void EvaluationPopulationsController::reset()
{
	// nothing to do.
}

vector<float> EvaluationPopulationsController::definirEntree(){
    vector<float> x;
    //Size 17
...
std::vector<float> EvaluationPopulationsController::calculateSortie(std::vector<float> x){
...
void EvaluationPopulationsController::step(){
    ...
    double maxRampSpeed = 0.05;
    double minRampSpeed = -0.05;
...
bool EvaluationPopulationsController::getCanCollect(){
    return this->canCollect;
}
bool EvaluationPopulationsController::getCanDropSlope(){
    return this->canDropSlope;
}
bool EvaluationPopulationsController::getCanDropNest(){
    return this->canDropNest;
}
bool EvaluationPopulationsController::getCanInstantDrop(){
    return this->instantDrop;
}
bool EvaluationPopulationsController::getObjCollected(){
    return this->objCollected;
}
bool EvaluationPopulationsController::getIsObserved(){
    return this->objObserved;
}
std::vector<int> EvaluationPopulationsController::getLayers(){
    return this->layers;
}

void EvaluationPopulationsController::setCanCollect(bool c){
    this->canCollect = c;
}
void EvaluationPopulationsController::setCanDropSlope(bool c){
    this->canDropSlope = c;
}
void EvaluationPopulationsController::setCanDropNest(bool c){
    this->canDropNest = c;
}
void EvaluationPopulationsController::setCanInstantDrop(bool c){
    this->instantDrop = c;
}
void EvaluationPopulationsController::setIsObserved(bool c){
    this->objObserved=c;
}
void EvaluationPopulationsController::setObjCollected(bool c){
    this->objCollected = c;
    if(c == true){
...
void EvaluationPopulationsController::setLayers(std::vector<int> l){
    int nb = 0;
...
//Fonctions
void EvaluationPopulationsController::setGenome(std::vector<float> g){
...
void EvaluationPopulationsController::monitorSensoryInformation()
{
...
std::string EvaluationPopulationsController::inspect( std::string prefix )
{
