...
#ifndef RandomShapleyValueCONTROLLER_H
#define RandomShapleyValueCONTROLLER_H
...
class RandomShapleyValueController : public Controller
{	//[24]={-1,-1,-1,-1,-1,-1,-1,0.01,1,1,1,1,1,1,1,0.5,0,1,1,1,400,700,950,1000};
	...
	public:
		RandomShapleyValueController( RobotWorldModel *__wm );
		~RandomShapleyValueController();
