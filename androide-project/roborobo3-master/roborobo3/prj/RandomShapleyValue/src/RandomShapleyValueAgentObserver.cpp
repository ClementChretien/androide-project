...
RandomShapleyValueAgentObserver::RandomShapleyValueAgentObserver( )
{
}

RandomShapleyValueAgentObserver::RandomShapleyValueAgentObserver( RobotWorldModel *__wm )
{
	_wm = __wm;
}
...
void RandomShapleyValueAgentObserver::reset()
{
	// nothing to do.
}

void RandomShapleyValueAgentObserver::stepPre()
{
